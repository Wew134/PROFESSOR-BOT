...
BOT_TOKEN = environ['6018619087:AAGtT3dGkdneSAcYnn0i3YjN81l1MwGcw2s']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('MINURA ', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split(https://t.me/HDthought)]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://minurachamalka209:<password>@cluster0.hk3rzpo.mongodb.net/test")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

#maximum search result buttos count in number#
MAX_RIST_BTNS = int(environ.get('MAX_RIST_BTNS', "100"))
...
RemoveBG_API = environ.get("RemoveBG_API", "3YqHzPiHAxyWNJBXDmgzLgrP")
WELCOM_PIC = environ.get("WELCOM_PIC", "https://ibb.co/K2Htz3B")
...
SHORT_API = environ.get("2d0015152c853d117a163bc7a86f3a5f438ed078")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/HDthought')).split()]
